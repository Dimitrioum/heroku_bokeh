...
# df = bv1
df = bv2[(bv2['Cекция №1 Уровень НП'] < bv2['Cекция №1 Уровень НП'].quantile(.95))
           & (bv2['Cекция №2 Уровень НП'] < bv2['Cекция №2 Уровень НП'].quantile(.95))]
...
cline = p1.circle(df['время формирования точки на БВ'], df['Секция №1 Датчик в сливной магистрали'], line_width=2, color=Category10[2],
                 y_range_name="binary")
ccline = p1.circle(df['время формирования точки на БВ'], df['Секция №1 Датчик на уровне планки'], line_width=2, color=Category10[12],
                 y_range_name="binary")
dline = p1.circle(df['время формирования точки на БВ'], df['Cекция №1 Уровень НП'], line_width=2, color=Category10[3])
ddline = p1.circle(df['время формирования точки на БВ'], df['Секция №2 Датчик на уровне планки'], line_width=2, color=Category10[4],
                 y_range_name="binary")
eline = p1.circle(df['время формирования точки на БВ'], df['Cекция №3 Заливная горловина'], line_width=2, color=Category10[5],
                 y_range_name="binary")
fline = p1.circle(df['время формирования точки на БВ'], df['Секция №3 Датчик на дне отсека'], line_width=2, color=Category10[6],
                 y_range_name="binary")
gline = p1.circle(df['время формирования точки на БВ'], df['Секция №3 Датчик в сливной магистрали'], line_width=2, color=Category10[13],
                 y_range_name="binary")
ggline = p1.circle(df['время формирования точки на БВ'], df['Секция №2 Датчик на уровне планки'], line_width=2, color=Category10[15],
                 y_range_name="binary")
hline = p1.circle(df['время формирования точки на БВ'], df['Cекция №2 Уровень НП'], line_width=2, color=Category10[7])
...
kkline = p1.circle(df['время формирования точки на БВ'], df['Секция №4 Датчик на уровне планки'], line_width=2, color=Category10[11],
                 y_range_name="binary")
